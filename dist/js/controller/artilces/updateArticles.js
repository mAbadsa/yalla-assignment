...
var updateArticle = function (_a) {
    ...
    return function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
        var _a, title, content, id, userData, coverImage, uploadedImage, article, rows, error_1;
        var _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 2:
                    ...
                    return [4 /*yield*/, databaseQueries.getArticleById({
                            connection: connection_1.default,
                        })({
                            id: +id,
                        })];
                case 3:
                    article = (_c.sent()).rows;
                    return [4 /*yield*/, databaseQueries.updateArticle({ connection: connection_1.default })({
                            title: title || article.title,
                            content: content || article.content,
                            coverImage: uploadedImage.Location || article.coverImage,
                            id: +id,
                        })];
                case 4:
                    rows = (_c.sent()).rows;
